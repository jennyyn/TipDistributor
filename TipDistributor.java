        ...
        while (!stop) {
            ...
            try {
                ...
                if (end.equals("y") || end.equals("Y")) {
                    ...
                    String[] staff = {"Server 1", "Server 2", "Chef", "Sous Chef", "Kitchen Aid", "Host", "Busser"};
                   ...
                   //THIS IS A TEST
                    ...
                    double[] staffTips = {serverTips, serverTips, chefTips, souschefTips, kitchenAidTips, hostTips, busserTips};
